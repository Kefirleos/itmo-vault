...
queries = [
    "ИТМО 09.03.02 Разработка программного обеспечения",
    "ИТМО ИС у30 группа расшифровка",
    "ИТМО распределительное тестирование программирование математика английский первокурсники"
]

with open("out_ddg.txt", "w", encoding="utf-8") as f:
    import sys
    sys.stdout = f
    for q in queries:
        ddg_search(q)
